...
from addon.src.utils.logging import attach_meta, setup_logging

set_workspace_root(__file__)
from addon.src.utils.input_list_extract import extract_data
from addon.src.utils.pipeline_config import OMEGA_REGISTRY_STRICT_ALLOWLIST
from addon.src.utils.registry import (
...
def main():
    ...
    from addon.src.utils.loaders import load_yaml
    ...
    with open(
        ...
        copilot_log.write(
            f"[PATCH][{datetime.now().isoformat()}] Patched import for loaders: from addon.src.utils.loaders import load_yaml, load_inference_mappings\n"
        )
        copilot_log.write(
