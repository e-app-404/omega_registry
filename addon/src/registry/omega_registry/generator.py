...
from addon.src.registry.loaders import load_json_with_extract
from addon.src.registry.minimizer import (
    contract_minimize_meta,
    enforce_allowlist,
    flatten_options_to_voice_assistants,
    strip_null_fields,
)
from addon.src.registry.utils import generate_conflict_id
from addon.src.registry.writer import deduplicate_entities, write_registry
...
def generate(
    ...
    from addon.src.registry.contract import validate_entity_fields
    ...
    if profile == "audit":
        from addon.src.registry.audit_writer import write_audit_registry
