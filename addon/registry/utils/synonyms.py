# Centralized synonym dictionaries for entity normalization
# PATCH-ADD-MISSING-SYNONYMS-20250714: Added missing synonyms for full normalization coverage. See copilot_patches/PATCH-ADD-MISSING-SYNONYMS-20250714.log for details.
