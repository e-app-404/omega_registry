...
purpose: "<addon | registry | docs-only | mixed>"
default_branch: "main"
branch_model: "<trunk | gitflow | release/*>"
remotes:
  primary_push: "<ssh://...>"
  additional:
    - name: "origin"
      ...
      push: true
    - name: "tailnet"
      url: "<ssh://tailscale-ip-or-host/...>"
      push: false
network:
  lan_ip: "192.168.x.y"
  tailnet_ip: "100.xx.yy.zz"
  synology_git_shell_wrapped: true
governance:
  protected_branches: ["main"]
  commit_signing_required: false
  pr_checks_required: ["lint", "tests"]
files:
  expects_large_binaries: false
  git_lfs_needed: false
  allows_symlinks: false
paths:
  uses_container_literals: true     # e.g. /config, /data (should remain literal)
  must_parameterize_host_paths: true
ci_cd:
  platform: "github-actions"
  release_tags: "semver"
nas_mirror:
  path: "/volume1/git-mirrors/<repo>.git"
  owner: "gituser:users"
  parents_g_rx: true
backup_policy:
